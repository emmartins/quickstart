...
This example demonstrates the deployment of an *EJB 3.1* bean bundled in a war archive for deployment to *JBoss Enterprise Application Platform 6* or *JBoss WildFly*. The project also includes a set of Aquillian tests for the managed bean and EJB.
