...
public class WebSocketRace {
    ...
    public static class ServerEndpointConfigurator extends ServerEndpointConfig.Configurator {
        ...
        public void modifyHandshake(ServerEndpointConfig sec, HandshakeRequest request, HandshakeResponse response) {
            ...
            System.out.println(environment.get(EnvironmentProperties.PROTOCOL));
            System.out.println(environment.get(EnvironmentProperties.SERVER_NAME));
            System.out.println(environment.get(EnvironmentProperties.SERVER_PORT));
            System.out.println(environment.get(EnvironmentProperties.ROOT_PATH));
        }
    }
}
