...
//***********************************************************************************
// FIXME don't forget to revert this in feature PR
:ProductRelease:
...
:githubRepoUrl: https://github.com/emmartins/quickstart/
...
:ImagePrefixVersion: eap73
:ImageandTemplateImportURL: https://raw.githubusercontent.com/jboss-container-images/jboss-eap-7-openshift-image/eap73/templates/

// OpenShift repository and reference for quickstarts
:EAPQuickStartRepo: https://github.com/emmartins/quickstart
:EAPQuickStartRepoRef: WFLY-12969-test
