...
NOTE: The application must be deployed to JBoss WildFly. It can not be deployed to JDG since it does not support deployment of applications.
...
4. Start JBoss WildFly into which you want to deploy your application
...
8. The application will be running at the following URL: <http://localhost:8080/wildfly-carmart/>
