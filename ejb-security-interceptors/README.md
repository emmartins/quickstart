...
The application this project produces is designed to be run on JBoss Enterprise Application Platform 6.1 or JBoss WildFly.2.
...
This quickstart is built around the default `ApplicationRealm` as configured in the JBoss Enterprise Application  Platform 6.1 or JBoss WildFly.2 server distribution. Using the add-user utility script, you must add the following users to the `ApplicationRealm`:
