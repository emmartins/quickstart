...
This example demonstrates the use of *CDI 1.0* and *PicketLink IDM* using JPA to store identities in *JBoss Enterprise Application Platform 6* or *JBoss WildFly*.
